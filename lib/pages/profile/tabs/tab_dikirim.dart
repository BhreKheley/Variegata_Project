...
class TabDikirim extends StatefulWidget {
  const TabDikirim({super.key});

  @override
  State<TabDikirim> createState() => _TabDikirimState();
}

class _TabDikirimState extends State<TabDikirim> {
  @override
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Center(
              child: Text(
                "Belum ada item yang Dikirim nih.",
                style: TextStyle(
                    color: Colors.black,
                    fontSize: 23,
